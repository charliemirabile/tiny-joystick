...
#define  USB_CFG_VENDOR_ID       0xc0, 0x16 //obdev
 ...
 */
#define  USB_CFG_DEVICE_ID       0xe4, 0x05 //midi
 ...
 */
#define USB_CFG_VENDOR_NAME     'm', 'i', 't', 'x', 'e', 'l', 'a', '.' ,'c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'M', 'i', 'n', 'i', ' ', 'P', 'i', 't', 'c', 'h', 'b', 'e', 'n', 'd', ' ', 'J', 'o', 'y', 's', 't', 'i', 'c', 'k'
